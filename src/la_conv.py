...
class LaplaceConvNet:
    ...
    def train(self, train_set: DataLoader, validation_set: DataLoader, experiment_path: Path = None) -> Tuple[
        List, List]:
        ...
        self.la = Laplace(self.regular_convnet.nn, 'regression', hessian_structure="diag")
